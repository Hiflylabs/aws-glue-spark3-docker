...
RUN tar -C /opt -xvf spark-3.1.1-amzn-0-bin-3.2.1-amzn-3.tgz && \
	curl -SsL https://mirror.checkdomain.de/apache/zeppelin/zeppelin-0.10.0/zeppelin-0.10.0-bin-all.tgz | tar -C /opt -xzf -

# Copy and extract spark-3
COPY ./spark-3.1.1-amzn-0-bin-3.2.1-amzn-3.tgz /temp/spark-3.1.1-amzn-0-bin-3.2.1-amzn-3.tgz
RUN mkdir /opt/amazon && tar -C /opt/amazon/ -xvf /temp/spark-3.1.1-amzn-0-bin-3.2.1-amzn-3.tgz
